...
from mysite.admin.views import (
    ...
    AddFriendsAdmin, CountryAdmin, RatingAdmin, LessonLevelAdmin,
    LessonCompletionAdmin, AchievementAdmin, UserAchievementAdmin,
    # ✅ CHAT
    ChatGroupAdmin, GroupPeopleAdmin, ChatMessageAdmin, ChatReadStateAdmin
)
...
def setup_admin(app: FastAPI):
    ...
    admin.add_view(ChatReadStateAdmin)
